...
func init() {
	httpcaddyfile.RegisterHandlerDirective("basicauthx", parseCaddyfile)
}
...
func parseCaddyfile(h httpcaddyfile.Helper) (caddyhttp.MiddlewareHandler, error) {
	var ba HTTPBasicxAuth
	ba.HashCache = new(caddyauth.Cache)
	...
	return caddyauth.Authentication{
		ProvidersRaw: caddy.ModuleMap{
			"http_basicx": caddyconfig.JSON(ba, nil),
		},
	}, nil
}
